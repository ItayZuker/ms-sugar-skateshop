...
import DSProdOneOpt from "./d-s-prod-one-opt/d-s-prod-one-opt"
import "./d-s-prod-opt-select.scss"

const DSProdOptSelect = () => {
    ...
    /* JSX */
    return (
        <div className="d-s-prod-opt-select-container">
            {productOptions.map((option, i) => {
                return <DSProdOneOpt key={i} option={option}/>
            })}
        </div>
    )
}

export default DSProdOptSelect