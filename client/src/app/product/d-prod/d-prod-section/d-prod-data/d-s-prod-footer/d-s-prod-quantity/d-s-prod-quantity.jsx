...
import "./d-s-prod-quantity.scss"

const DSProdQuantity = ({quantity, setQuantity}) => {
    ...
    if (storeDisplay?.variant?.available) {
        return (
            <div className="d-s-prod-quantity-container">
                <p>Quantity:</p>
                <div className="d-s-prod-quantity-inner-container">
