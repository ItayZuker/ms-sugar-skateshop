...
const EFormIAgree = ({ iAgree, setIagree, data, dialog }) => {
    ...
    return (
        <div 
            ...
            <p>By sending your art, you agree that Ms-Sugar might use it in a commercial way. Read more on <Link to="/terms-and-conditions" target="_blank">Terms and conditions.</Link></p>
